    ...
    <body>
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading" id="heading" align="center"><h2>View/Edit Details</h2></div>
                    ...
                    <table width="70%" align="center">
                        ...
                        <tr>
                            <td colspan="6" align="center">
                                <input type="button" class="btn btn-primary" name="add" value="Search" id="search_btn" onclick="ViewEdit()" /></td>
                        </tr>
                    </table>
                </div>
            </div>
