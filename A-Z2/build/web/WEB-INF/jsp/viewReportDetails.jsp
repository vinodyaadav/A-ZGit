   ...
   <head>
    ...
    <c:when test="${fn:length(custDetails) gt 0}">
            <tr>
                ...
                <td align="center"><input type="button" name="report" class="btn btn btn-primary" value="Generate PDF Report" onclick="generatePDF('${custName}','${contactNo}','${subDate}','${formType}')"/></td>
            </tr>
      ...
      <td colspan="13" align="center"><div id="showLink" style="display: none"><a target="_blank" href="aadharCard.htm?actionFrom=showPdf">Open PDF</a></div></td>
